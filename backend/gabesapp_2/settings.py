"""
Django settings for gabesapp_2 project.
...
WSGI_APPLICATION = 'gabesapp_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gabesapp_2 API",
    "DESCRIPTION": "API documentation for gabesapp_2 App",
    "VERSION": "v1",
}
